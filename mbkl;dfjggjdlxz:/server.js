...
matrixGenerator(30,25,15,10,5,1);
//! Creating MATRIX -- END
    ...
    for (var y = 0; y < matrix.length; y++) {
        for (var x = 0; x < matrix[y].length; x++) {
            if (matrix[y][x] == 2) {
                ...
                var Predators = new Predator(x, y);
                predatorArr.push(Predators);
                predatorHashiv++;
            }

            else if (matrix[y][x] == 4) {
                var _charac4 = new Character4(x, y);
                charac4Arr.push(_charac4); 
                charac4Hashiv++;
            }

            else if (matrix[y][x] == 5) {
                var _charac5 = new Character5(x, y);
                charac5Arr.push(_charac5); 
                charac5Hashiv++;
            }
